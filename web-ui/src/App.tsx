...
const KEY_MAP: Record<string, number> = {
  "1": 0, "2": 2, "3": 3, "4": 4, "5": 1, "6": 5, "7": 6, "8": 9, "9": 11, "0": 12,
};
...
export default function App() {
  ...
  const { onPointerDown, onPointerMove, onPointerUp } = usePainting(
    canvasRef, W, H, (x, y) => sim.paint(x, y, currentMaterial, brushRadius),
  );
  ...
  return (
    <div className="app">
      <aside className="sidebar">
        <h1 className="title">SandSim <span className="fps">{sim.fps} fps</span></h1>
        ...
        <div className="bottombar">
          ...
          <div className="ctrl-group">
            ...
            <div className="btn-row">
              ...
              <button className="ctrl-btn" onClick={sim.step} disabled={!paused}>⏭ Step</button>
              <button className="ctrl-btn danger" onClick={sim.clear}>Clear</button>
            </div>
          </div>
